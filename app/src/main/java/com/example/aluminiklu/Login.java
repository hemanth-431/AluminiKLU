...
try {
    if (bundle.getString("STRING_I_NEED") != null) {
        ...
        if(user!=null) {
            finish();
            startActivity(new Intent(Login.this, Side_drawer.class));
        }
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            if(mAuth.getCurrentUser().isEmailVerified())
                            {
                                ...
                                c.updatetoken(FirebaseInstanceId.getInstance().getToken());

                                Intent intent = new Intent(Login.this, Side_drawer.class);
                                ...
                                Toast.makeText(Login.this,"Please Check Your Mail!",Toast.LENGTH_LONG).show();
